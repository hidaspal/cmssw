...
#        ), 
        cms.PSet(
            record = cms.string('SiPixelSomeThingRcd'),
            tag = cms.string('SiPixelSomeThing_v01')
        ),
###        cms.PSet(
...
###### SOMETHING OBJECT ######
process.SiPixelSomeThing = cms.EDAnalyzer("SiPixelSomeThingDB",
    ...
    #in case something values for bpix should be read from file -> not implemented yet
    useFile = cms.bool(False),
    record = cms.untracked.string('SiPixelSomeThingRcd'),  
    fileName = cms.string('someThing.txt')	
)
